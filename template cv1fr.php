...
if (isset($_POST['name'])) {
    ...
    $sql = "INSERT INTO table1 ( nom, prenom, adresse, telephone,
    email, competence1, competence2, competence3, competence4, nomentreprise, posteoccupe, datedebut, datefin, descriptiontaches,
    nomecole, diplomeobtenu, anneedebut, anneefin, domaineetude) 
    VALUES (
      '$name', '$firstname', '$address', '$phone', '$email',
      '$skill1', '$skill2', '$skill3', '$skill4', '$company', '$position', '$start_date', '$end_date', '$description',
      '$school', '$degree', '$start_year', '$end_year', '$field_of_study'
    )";
...
$select_query = "SELECT * FROM table1 ORDER BY code DESC LIMIT 1";
...
<body>
  ...
  <div class="container">
    ...
    <a href="generer_cv1fr.php" class="button">Télécharger CV en PDF</a>
  </div>
</body>
</html>
